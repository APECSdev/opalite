...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      verifyAge: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`verifyAge: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyAge',
                                     'argument 1 (as invoked from Typescript)',
                                     'age_verification.compact line 7 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._verifyAge_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = { verifyAge: this.circuits.verifyAge };
    this.provableCircuits = { verifyAge: this.circuits.verifyAge };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
  ...
  _verifyAge_0(context, partialProofData) {
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
